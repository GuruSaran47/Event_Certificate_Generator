...
S0: Go to file: ".\image_module.py" \
S1: Go to the class "write_text" (You can search this upon opening the editor) \
&emsp;S1.1: Add your class private member parameter "self.__p_xxx" \
&emsp;S1.2: Go to the class function "__run_generator__" \
&emsp;S1.3: Add your present variable "print_xxx" to hold the new field extracted from the csv file. e.g: print_xxx = self.__data[index][n] #where n is the nth index you are referring to. \
&emsp;S1.4: Add the last line image.text(self.__p_xxx,print_add1,font=font,fill=(0,0,0)) \
